...
#***************************************************************************************************
    def load_pose(self, pos, vel, yaw): # integrate with feedback subsystem
        # for i in range (len(data.name)):
        #     if data.name[i] == 'prius':
        #         idx = i
        self.prius_position = pos.position
...
#**************************************************************************************
    ...
    # def slope(self):
    #     self.zgradients = np.gradient(self.z_waypoints)
...
#     # rospy.init_node("PriusNode", anonymous=True)
#     x_waypoints, y_waypoints = openfile("setpoints_w2.txt")
#     # x_waypoints,y_waypoints = load("final_w1.npy")
